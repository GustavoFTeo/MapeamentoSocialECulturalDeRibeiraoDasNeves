        ...
        <div class="container text-center my-4">
            ...
            <div class="d-flex justify-content-center">
                <div class="card mb-3 w-75">
                    <img src="imagemdiquebrada.png" class="card-img-top imagemdiquebrada" alt="...">
                    <div class="card-body">
                        <p class="card-text p-Ref">R. Cenira Gurgel de Carvalho, 137 - São João de Deus (Justinópolis), Ribeirão das Neves - MG, 33943-360</p>
                        <p class="card-text p-Ref"><small class="p-Ref2">Retirado de: https://www.google.com/maps/contrib/105564481576825213493/photos/@-19.8080257,-44.0149405,17z/data=!3m1!4b1!4m3!8m2!3m1!1e1?entry=ttu&g_ep=EgoyMDI1MTEyMy4xIKXMDSoASAFQAw%3D%3D. Acesso em: 02 de dez. 2025</small></p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center">
                <div class="card mb-3 w-75">
                    <img src="imagemdiquebrada2.webp" class="card-img-top imagemdiquebrada2" alt="...">
                    <div class="card-body">
                        <h5 class="card-title p-Ref">Formatura de cursos de qualificação profissional</h5>
                        <p class="card-text p-Ref">O Centro Cultural Di Quebrada é um espaço dedicado à arte, educação e valorização da cultura periférica. 
                            Criado para ser um ponto de encontro da comunidade, o centro promove atividades como oficinas de dança, música, 
                            grafite, teatro, rodas de conversa e projetos sociais que fortalecem o sentimento de pertencimento.
                            Mais do que um local de eventos, o Centro Cultural di Quebrada funciona como uma plataforma de oportunidades, 
                            abrindo portas para talentos locais e incentivando jovens e adultos a se expressarem através da arte. 
                            É um símbolo de resistência, identidade e transformação dentro da quebrada.</p>
                             <p class="card-text p-Ref"><small class="p-Ref2">Retirado de: https://www.google.com/maps/contrib/105564481576825213493/photos/@-19.8080257,-44.0149405,17z/data=!3m1!4b1!4m3!8m2!3m1!1e1?entry=ttu&g_ep=EgoyMDI1MTEyMy4xIKXMDSoASAFQAw%3D%3D. Acesso em: 02 dez. 2025</small></p>
                    </div>
                </div>
            </div>
                <p>
                A missão do Centro Cultural Di Quebrada é promover a valorização da cultura periférica, oferecendo acesso à arte, 
                educação e oportunidades para a comunidade. O centro busca fortalecer identidades, estimular o protagonismo juvenil,
                 incentivar a criatividade, gerar transformação social e construir um espaço onde todos possam aprender, se expressar e se reconhecer.
                </p>
                <div class="d-flex justify-content-center">
                    <div class="card mb-3 w-75">
                    <img src="imagemdiquebrada3.jpg" class="card-img-top imagemdiquebrada3" alt="...">
                    <div class="card-body">
                        <h5 class="card-title p-Ref">Centro Cultural di Quebrada: missão, origem coletiva e força da cultura periférica</h5>
                        <p class="card-text p-Ref">
                            O Centro Cultural di Quebrada foi formado por agentes culturais da sociedade civil de Ribeirão das Neves, ligados à Rede de Trabalhadores da Cultura, 
